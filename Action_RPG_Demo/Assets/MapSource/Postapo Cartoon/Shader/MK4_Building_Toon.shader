...
///////// Gloss:
                ...
                float4 node_1538 = tex2D(_Leaks,TRANSFORM_TEX(node_7145, _Leaks));
                float2 node_4126 = float2((i.posWorld.r*node_2107),node_828);
                float4 node_8935 = tex2D(_Leaks,TRANSFORM_TEX(node_4126, _Leaks));
