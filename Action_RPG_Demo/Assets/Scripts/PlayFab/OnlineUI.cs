...
public class OnlineUI : MonoBehaviour, IPointerClickHandler, IPointerMoveHandler, IPointerExitHandler
{
    ...
    public void OnCameraArriveTarget(GameObject PointObj)
    {
        HideAllPanels();
    ...
    public bool RayCheckInsideUi(PointerEventData EventData, out RaycastHit Hit)
    {
        Hit = new RaycastHit();
    ...
    public void CheckHoverObject(PointerEventData EventData)
    {
        if (_IsAtMenu == false)
        {
            ClearHoverBlock();
